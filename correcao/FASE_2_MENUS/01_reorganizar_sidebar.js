/**
 * ============================================================================
 * CORRECAO FASE 2 - 01 v3 - Reorganizar sidebar (auto-detect CRLF/LF)
 * ============================================================================
...
function garantirBackup(relPath) {
  ...
  const backupPath = path.resolve(BACKUP_DIR, 'f2_01v3_' + relPath.replace(/[\\/]/g, '__'));
...
console.log('\n=============================================');
console.log('  FASE 2 / 01 v3 - Reorganizar sidebar');
...
// 1) Le o arquivo BRUTO (bytes) para detectar CRLF/LF
let html = fs.readFileSync(absPath, 'utf8');

// 2) Detecta qual quebra de linha predomina
const temCRLF = html.includes('\r\n');
const NL = temCRLF ? '\r\n' : '\n';
console.log('   Quebra de linha detectada: ' + (temCRLF ? 'CRLF (\\r\\n)' : 'LF (\\n)'));
console.log('');

// 3) Monta as substituicoes usando a quebra detectada
const SUBS = [
  {
    de: [
      '      <div class="nav-submenu" id="grupo-operacao">',
    ...
    descricao: 'Operacao: renomear KM -> Quilometragem + adicionar Manutencao/Documentos/Historico',
  },
  {
    de: [
      '      <div class="nav-submenu" id="grupo-financeiro">',
    ...
    descricao: 'Financeiro: remover Manutencao + Documentos',
  },
];
...
console.log('  1. git add . && git commit -m "feat(menu): reorganizar sidebar"');
