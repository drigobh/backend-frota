/**
 * ============================================================================
 * CORRECAO 03b - Limpar duplicacao de preHandler no alertas.js
 * ============================================================================
 * RODAR (dry-run):   node correcao/FASE_1_CRITICA/03b_limpar_alertas.js
 * RODAR (aplicar):   node correcao/FASE_1_CRITICA/03b_limpar_alertas.js --apply
 * ============================================================================
 */
...
console.log('\n=============================================');
console.log('  CORRECAO 03b - Limpar duplicacao alertas');
...
const backupPath = path.resolve(BACKUP_DIR, '03b_' + ARQUIVO.replace(/[\\/]/g, '__'));
