...
console.log('🔧 Corrigindo escape de aspas em src/routes/auditoria.js...');
...
// Valida sintaxe antes de escrever no disco
try {
  new vm.Script(auditoriaCode);
  fs.writeFileSync(auditoriaPath, auditoriaCode, 'utf8');
  console.log('✔ src/routes/auditoria.js corrigido e validado com 0 erros de sintaxe!');
} catch (e) {
  console.error('❌ Erro de sintaxe detectado:', e.message);
  process.exit(1);
}
